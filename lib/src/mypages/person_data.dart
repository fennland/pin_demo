...
class _person_dataState extends State<person_data> {
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              if (_isSelected) {
                                ...
                                buttonText = textEditingController.text; // 使用输入的文本作为按钮文本
                              } else {
  ...
  Row _radioRow(){
    return Row(
      ...
      children: [
        const Expanded(flex: 1, child: Padding(padding: EdgeInsets.all(8.0), child: Text("性别"))),
        const SizedBox(),
        Expanded(flex: 1, child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, children: [Text("男"),
      _colorfulCheckBox(1),
      Text("女"),
      _colorfulCheckBox(0),
      Text("保密"),
